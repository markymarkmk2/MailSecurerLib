 ...
 */
public
class LocZipInputStream extends InflaterInputStream implements LocZipConstants {
     ...
     */
    public LocZipInputStream(InputStream in)
    {
	...
	readFully(b, 0, len);
        ...
        try
        {
            fname = getUTF8String(b, 0, len);
        }
        catch (Exception e)
        {
            fname = new String( b, 0, len, "ISO-8859-1" );
        }

        
	ZipEntry e = createZipEntry( fname );
