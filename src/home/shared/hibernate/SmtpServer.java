 ...
 */
public class SmtpServer  implements java.io.Serializable {
    ...
    public SmtpServer(int id, DiskArchive diskArchive, Mandant mandant, String server, Integer port, String username, String password, String flags, String type) {
       this.id = id;
       this.diskArchive = diskArchive;
       this.mandant = mandant;
       this.server = server;
